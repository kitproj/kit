...
```bash
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/vvv0.1.77/kit_vv0.1.76_linux_386
...
```bash
go install github.com/kitproj/kit@vvv0.1.77
```
