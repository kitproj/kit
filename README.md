...
```bash
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/v0.1.98/kit_v0.1.98_linux_386
...
```bash
go install github.com/kitproj/kit@v0.1.98
```
