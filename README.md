...
```bash
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/v0.1.91/kit_v0.1.91_linux_386
...
```bash
go install github.com/kitproj/kit@v0.1.91
```
