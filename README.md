...
```bash
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/vv0.1.76/kit_vv0.1.76_linux_386
...
```bash
go install github.com/kitproj/kit@vv0.1.76
```
