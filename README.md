...
```bash
# For Linux (amd64)
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/v1.0.2/kit_v1.0.2_linux_amd64
sudo chmod +x /usr/local/bin/kit

# For Linux (arm64)
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/v1.0.2/kit_v1.0.2_linux_arm64
sudo chmod +x /usr/local/bin/kit

# For MacOS (Intel)
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/v1.0.2/kit_v1.0.2_darwin_amd64
sudo chmod +x /usr/local/bin/kit

# For MacOS (Apple Silicon)
sudo curl --fail --location --output /usr/local/bin/kit https://github.com/kitproj/kit/releases/download/v1.0.2/kit_v1.0.2_darwin_arm64
sudo chmod +x /usr/local/bin/kit

# For Go users
go install github.com/kitproj/kit@v1.0.2
```
